          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <textarea
                ...
                maxLength={160}
                rows={3}
                className="w-full p-3 border border-white/10 rounded-lg resize-none text-gray-100"
              />
            </div>
            <div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="p-4 bg-white/5 border border-white/5 rounded-lg">
                ...
                <div className="text-lg text-indigo-300 hover:underline cursor-pointer truncate">
                  {title || "Page Title"}
                </div>
